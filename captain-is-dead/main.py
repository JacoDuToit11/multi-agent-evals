...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Run "The Captain is Dead" game simulation')
    parser.add_argument('--characters', type=int, default=2, help='Number of characters/agents (1-6)')
    parser.add_argument('--threats', type=int, default=2, help='Number of initial threats (0-4)')
    ...
    parser.add_argument('--deterministic', action='store_true', default=True, help='Use deterministic mode with default seed 42')
    ...
    # Create the game with the specified complexity
    game = Game(
